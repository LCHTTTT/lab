...
public class sychart : MonoBehaviour
{
    void Start()
    {
        ...
        mySqlTools.Open();
        var a = mySqlTools.ExecuteQuery("SELECT  COUNT(*)  FROM  students  WHERE  syscore  BETWEEN  0  AND  29;");
        var b = mySqlTools.ExecuteQuery("SELECT  COUNT(*)  FROM  students  WHERE  syscore  BETWEEN  30  AND  59;");
        var c = mySqlTools.ExecuteQuery("SELECT  COUNT(*)  FROM  students  WHERE  syscore  BETWEEN  60  AND  89;");
        var d = mySqlTools.ExecuteQuery("SELECT  COUNT(*)  FROM  students  WHERE  syscore  BETWEEN  90  AND  100;");
