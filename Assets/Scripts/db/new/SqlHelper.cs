...
namespace Imdork.Mysql
{
    ...
    public class SqlHelper : IDisposable
    {
        ...
        public void Connect(string host, string port, string user, string passwd, string database, string format = "utf8mb3")
        {
            _server = host;
            ...
            _datename = database;
            _format = format;
            connectStr = string.Format("server={0};port={1};user={2};password={3};database={4};charset={5};SslMode=None", _server, _port, _user, _password, _datename, _format);//设置连接ip，端口，用户名，密码，以及编码格式    
